  ...
  const products = [
    {
      ...
      volume: "500 мл",
      fullDescription: "Напиток 'Бодрость' разработан для повышения физической и умственной работоспособности. Содержит экстракты родиолы розовой, элеутерококка и сибирского женьшеня — растений-адаптогенов, которые помогают организму справляться со стрессом и нагрузками.",
      ingredients: [
