...
const Index = () => {
  ...
  const products = [
    ...
    },
    {
      name: "Баланс",
      description: "Кипрей узколистный, облепиха крушиновидная, череда трехраздельная, душица обыкновенная",
      benefit: "Напиток для внутреннего равновесия и комфорта",
      volume: "500 мл",
  ...
  const ingredients = [
    {
      name: "Кипрей узколистный (Иван-чай)",
      effect: "Натуральный тоник",
      description: "Содержит флавоноиды и танины, способствует мягкому повышению энергии и снижению напряжения. Обладает противовоспалительными свойствами.",
    },
    {
      name: "Облепиха крушиновидная",
      effect: "Витаминный комплекс",
      description: "Богата витаминами С, Е, К и каротиноидами. Способствует восстановлению сил, поддержанию иммунитета и здоровью кожи.",
    },
    {
      name: "Череда трёхраздельная",
      effect: "Очищение и баланс",
      description: "Содержит полифенолы и флавоноиды, способствует нормализации обмена веществ и обладает мягким детокс-эффектом.",
    },
    {
      name: "Лабазник вязолистный (Таволга)",
      effect: "Комфорт и гармония",
      description: "Известен высоким содержанием салицилатов. Способствует снятию дискомфорта, уменьшению напряжения и поддержанию общего баланса организма.",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-scale-in">
              <img
                src="https://cdn.poehali.dev/projects/be015741-f2a1-4265-97b5-2c321af44282/bucket/0e49bcdd-90c4-4952-8b56-fe502f12487b.jpg"
                alt="Травяные напитки Гармония, Бодрость и Баланс"
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed text-justify">Мы начинаем с глубокого изучения природы. Каждое растение, которое попадает в наши напитки, сначала исследуется в лаборатории: мы определяем его уникальный химический состав, концентрацию природных веществ и совместимость с другими компонентами. Этот научный подход позволяет нам создавать сбалансированные рецептуры, где каждый ингредиент дополняет друг друга, раскрывая максимальную пользу и гармонию вкуса.
